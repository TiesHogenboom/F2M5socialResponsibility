<nav class="navbar">
        ...
        <div class="navbar-links">
          <ul>
            ...
            <li><a href="<?php echo url( 'home' ) ?>"<?php if ( current_route_is( 'home' ) ): ?> class="active"<?php endif ?>>Over Ons</a></li>
            <li><a href="<?php echo url( 'Contact' ) ?>"<?php if ( current_route_is( 'Contact_form' ) ): ?> class="active"<?php endif ?>>Contact</a></li>
              <li><a href="<?php echo url( 'Contact' ) ?>"<?php if ( current_route_is( 'Contact_form' ) ): ?> class="active"<?php endif ?>>Word Transformer</a></li>
