<nav class="navbar">
        ...
        <div class="navbar-links">
          <ul>
            ...
            <li><a style="color: #ff6016;" class="rgi" href="<?php echo url( 'login' ) ?>"<?php if ( current_route_is( 'login' ) ): ?> class="active"<?php endif ?>>Inloggen</a></li>
            <li><a class="regi" href="<?php echo url( 'registreren' ) ?>"<?php if ( current_route_is( 'registreren' ) ): ?> class="active"<?php endif ?>>Registreren</a></li>
